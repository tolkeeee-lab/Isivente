...
export const UPSELL_CONFIG: Record<string, ProductUpsellConfig> = {
  ...
  trozk: {
    secondUnit: {
      ...
      title: "Ajoutez une 2ème Batterie Modulaire Trozk T3 pour un proche ou la voiture",
      subtitle: "Ne soyez plus jamais à court de batterie lors de vos déplacements ou coupures",
      description: "Recevez une 2ème batterie complète 15 000 mAh avec son étui rigide et tous ses modules pour 16 900 FCFA au lieu de 24 900 FCFA.",
      price: 16900,
      originalPrice: 24900,
      savings: 8000,
    ...
    bump: {
      id: "trozk-fast-cable",
      title: "Câble Ultra-Rapide 60W Métal & Nylon Tressé Indestructible",
      subtitle: "Charge ultra-rapide compatible iPhone 15/16, Samsung, Huawei et PC Portable",
      description: "Recharge à pleine vitesse 22.5W/60W sans surchauffe avec connecteurs renforcés.",
      price: 2900,
      originalPrice: 6000,
      savings: 3100,
      image: "/images/trozk-hero.jpg",
      badge: "-52% ACCESSOIRE",
      benefits: [
        "Puissance jusqu'à 60W Power Delivery",
        "Gaine en nylon tressé anti-nœud ultra-résistante",
        "Garantie anti-casse 2 ans",
      ],
    },
    upsell: {
      id: "trozk-second",
      ...
      description: "Profitez de cette opportunité unique pour ajouter une 2ème batterie complète avec tous ses accessoires pour 16 900 FCFA au lieu de 24 900 FCFA.",
      price: 16900,
      originalPrice: 24900,
      savings: 8000,
      image: "/images/trozk-hero.jpg",
