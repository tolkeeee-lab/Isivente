      ...
      <aside className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-white border-r border-slate-200/80 flex flex-col transition-transform duration-200 ease-[cubic-bezier(0.16,1,0.3,1)] ${sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}>
        ...
        <div className="p-3.5 border-t border-slate-100 space-y-1.5">
          <a 
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center justify-between px-3.5 py-2.5 rounded-xl text-xs font-semibold bg-indigo-50 text-indigo-700 border border-indigo-100 hover:bg-indigo-100/80 transition-colors shadow-2xs"
          >
            <span className="flex items-center gap-2">
              <ExternalLink className="w-3.5 h-3.5 text-indigo-600" />
              <span>Voir le Microscope</span>
            </span>
            <span className="text-[10px] bg-indigo-600 text-white px-1.5 py-0.5 rounded font-mono font-bold">Nouveau</span>
          </a>
      ...
      <main className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden">
        ...
        <header className="h-18 bg-white border-b border-slate-200/80 flex items-center justify-between px-6 lg:px-10 shrink-0">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3">
            {/* Lien direct Voir la boutique */}
            <a
              href="/p/microscope"
              target="_blank"
              rel="noreferrer"
              title="Ouvrir la page de vente du Microscope"
              className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold text-indigo-700 bg-indigo-50 hover:bg-indigo-100/90 active:scale-95 transition-all duration-150 border border-indigo-100 shadow-2xs cursor-pointer"
            >
              <ExternalLink className="w-3.5 h-3.5 text-indigo-600" />
